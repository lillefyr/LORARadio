...
SX1278 lora = new Module(16, 15, 15); 
...
void setup() {
  ...
  float CARRIER_FREQUENCY = 868.7f; // 436.7f;
  float DEFAULT_CARRIER_FREQUENCY = 868.7f; // 436.7f;
  ...
  char  SYNC_WORD = 0xff;  //0f0f for SX1262  //really wrong
